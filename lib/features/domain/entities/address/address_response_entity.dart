...
AddressResponseEntity addressResponseEntityFromJson(String str) =>
    AddressResponseEntity.fromJson(json.decode(str));

String addressResponseEntityToJson(AddressResponseEntity data) =>
